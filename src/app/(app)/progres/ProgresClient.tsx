...
import { saveProgressIqro, saveProgressSholat } from '@/lib/actions';
...
export default function ProgresClient({ students, iqroProgress, sholatProgress }: { students: any[], iqroProgress: any[], sholatProgress: any[] }) {
  const [activeTab, setActiveTab] = useState<'iqro' | 'sholat'>('iqro');
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-secondary text-sm">Catat perkembangan mengaji dan penilaian ibadah sholat santri.</p>
      </div>
